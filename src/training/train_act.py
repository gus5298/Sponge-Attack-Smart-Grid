...
from config import (CONTEXT_LEN, PREDICTION_LEN, NUM_FEATURES, BATCH_SIZE,
                    ...
                    MAX_EPOCHS, DATA_PATH, ACT_MODEL_PATH, MODELS_DIR, ALL_FEATURES)
...
if __name__ == "__main__":
    ...
    for epoch in epoch_bar:
        ...
        for x, y in tqdm(train_loader, desc=f"Epoch {epoch+1}", leave=False, unit="batch"):
        ...
        epoch_bar.set_postfix(loss=f"{val_loss:.4f}", ponder=f"{val_ponder:.1f}/{MAX_PONDERS}")
