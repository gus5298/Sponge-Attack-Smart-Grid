...
from utils.model_loader import load_deepar, load_seed_from_csv, make_predictor
...
print("=" * 70)
print("DeepAR-LSTM PGD ENERGY ATTACK (WHITE-BOX)")
print("=" * 70)
...
if __name__ == "__main__":
    ...
    print_results("DeepAR PGD ENERGY ATTACK", [
    ...
    np.save(os.path.join(OUT, "deepar_pgd_energy_best_input.npy"), adv_input)
    ...
    plot_pgd_results(step_data, base_stats, adv_stats,
                     ...
                     'DeepAR-LSTM PGD Energy Attack', os.path.join(OUT, 'deepar_pgd_energy_results.png'))
