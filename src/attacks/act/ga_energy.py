...
print("=" * 70)
print("ACT-LSTM ENERGY ATTACK - Maximizing Energy Consumption")
print("=" * 70)
...
if __name__ == "__main__":
    best_solution, _ = run_ga(ga_instance, "ACT-LSTM Energy Attack")
    ...
    plot_ga_evolution(history.generation_data,
                      ...
                      'ACT-LSTM Energy Attack Results', os.path.join(OUT, f"{prefix}_results.png"))
