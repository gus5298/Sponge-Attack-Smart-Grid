...
from config import (CONTEXT_LEN, NUM_FEATURES, PREDICTION_LEN,
                    REPS_PER_MEASUREMENT, POPULATION_SIZE,
                    ENERGY_SAMPLE_INTERVAL, VERIFICATION_REPS, OUTPUT_DIR)
...
print("="*70)
print("CHRONOS ENERGY SPONGE ATTACK - Maximizing Power Consumption")
print("="*70)
...
if __name__ == "__main__":
    best_solution, _ = run_ga(ga_instance, "Chronos Energy Sponge Attack")
    ...
    print_results("CHRONOS ENERGY SPONGE ATTACK", [
    ...
    plot_ga_evolution(history.generation_data,
                      ...
                      'Chronos Energy Sponge Attack Results', os.path.join(OUT, f"{prefix}_results.png"))
