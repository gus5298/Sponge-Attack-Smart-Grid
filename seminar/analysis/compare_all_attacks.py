...
Usage:
    python analysis/compare_all_attacks.py --metric latency
    python analysis/compare_all_attacks.py --metric energy
"""
...
METRIC_CONFIG = {
    'latency': {
        ...
        'output': os.path.join(OUTPUT_DIR, 'comparisons', 'attack_comparison_summary.png'),
    },
    'energy': {
        'models': {
        ...
        'output': os.path.join(OUTPUT_DIR, 'comparisons', 'energy_attack_comparison_summary.png'),
    },
}
