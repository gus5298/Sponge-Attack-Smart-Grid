...
from config import CONTEXT_LEN, NUM_FEATURES, MAX_PONDERS, ALL_FEATURES
...
if __name__ == "__main__":
    ...
    adv_inputs = load_adversarial_inputs({
        ...
        'ACT GA Energy': "act_energy_best_input.npy",
        'ACT GA Latency': "act_latency_best_input.npy",
    })
    ...
    plt.tight_layout()
    plt.savefig('act_ponder_visualization.png', dpi=150)
    print("\nSaved: act_ponder_visualization.png")
    plt.close()
    ...
    if adv_inputs:
        ...
        plt.tight_layout()
        plt.savefig('act_ponder_correlation.png', dpi=150)
        print("Saved: act_ponder_correlation.png")
        plt.close()
