...
def plot_adversarial_analysis(model_name, baseline, adversarial, save_prefix, attack_type=''):
    ...
    # Save
    output_path = f'{save_prefix}_pattern_analysis.png'
...
def main():
    ...
    parser.add_argument('--model', type=str, required=True, help='Model name (e.g., chronos, deepar, act)')
    ...
    print("=" * 70)
    print(f"UNIFIED DIAGRAM GENERATION: {args.model.upper()} - {args.attack.upper()}")
    print("=" * 70)
    ...
    # Print statistics
    print_statistical_summary(args.model.upper(), baseline, adversarial, args.attack.capitalize())
    
    # Generate plots
    plot_adversarial_analysis(args.model.upper(), baseline, adversarial, args.output_prefix, args.attack.capitalize())
