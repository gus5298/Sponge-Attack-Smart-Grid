...
from utils.model_loader import load_deepar, load_seed
...
print("=" * 70)
print("DeepAR BIT-FLIP SPONGE ATTACK")
print("=" * 70)
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 70)
    print("FINAL RESULTS - DeepAR BIT-FLIP ATTACK")
    print("=" * 70)
    ...
    plot_ga_evolution(history.generation_data,
                      ...
                      'DeepAR Bit-Flip Sponge Attack', os.path.join(OUT, f"{prefix}_results.png"))
